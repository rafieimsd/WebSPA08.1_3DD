...
//		final boolean userIDFound = myServer.getWSDatabase().passPhrases.isPPIDInUse(usID);
		...
		if(userIDFound == false) {
			...
			final int numbers = myServer.readLineRequiredInt("Enter the the number of actions to be generated", 0, 256);
			...
			int action = myServer.readLineRequiredInt("Select an action number for this O/S Command", 0, 256);
